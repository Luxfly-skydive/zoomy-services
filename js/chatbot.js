...
},
{
  ...
  r:() => {
    ...
    return t(
      '**Chatbot pricing:**\n\n• Standard (1–2 languages, ~30 topics) — **$500**\n• Complex (multilingual, 50+ topics, booking/leads) — **$1,000–$1,500**\n• Monthly hosting (self-hosted) — **$50/month**\n• API-based — from $40/month\n\nAs an add-on to a website: **$400**. If you purchased a language package ($200/language), the chatbot in that language is **included** — no extra charge. Email **contact@zoomy.services** for an exact quote.',
